...
async function computeMatch(match, supabase = null) {
  ...
  return {
    ...
    ensemble_home_prob:   modelArchitecture !== 'DIXON_COLES' ? model.home  : null,
    ensemble_draw_prob:   modelArchitecture !== 'DIXON_COLES' ? model.draw  : null,
    ensemble_away_prob:   modelArchitecture !== 'DIXON_COLES' ? model.away  : null,
    _homeCat:        _homeCat,
    _drawCat:        _drawCat,
    _awayCat:        _awayCat,
    _maxEdge:        maxEdge,
