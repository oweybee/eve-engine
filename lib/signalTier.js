 ...
 * PRIME / WATCH / TRACE / NIL. Two of the words were shared and neither meant
 ...
 */
const LABELS = Object.freeze(['PRIME', 'WATCH', 'TRACE', 'NIL']);
...
const BAND_MIN = Object.freeze({ PRIME: 65, WATCH: 40, TRACE: 25, NIL: 0 });
 ...
 * @returns {'PRIME'|'WATCH'|'TRACE'|'NIL'|null}
 */
