...
function available() {
  return ['lambda_home.onnx', 'lambda_away.onnx', 'lambda_bundle.json']
    .every(f => fs.existsSync(path.join(MODEL_DIR, f)));
}
...
module.exports = { clubKey, available, loadBundle, buildVector, priceFixture,
                   credibleScore, segOf };
